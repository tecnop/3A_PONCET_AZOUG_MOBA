...
{
	protected SpellTarget(Metadata metadata, SpellCostType costType = SpellCostType.NONE, float spellCost = 0.0f)
		: base(metadata, SpellType.TARGET, costType, spellCost)
	{
